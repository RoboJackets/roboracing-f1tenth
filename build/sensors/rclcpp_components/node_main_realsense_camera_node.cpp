...
#define NODE_MAIN_LOGGER_NAME "realsense_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsensors.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<sensors::RealsenseCameraNode>";
